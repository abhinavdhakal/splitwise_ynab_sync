...
class Config:
    ...
    SW_API_KEY: str = os.getenv('SW_API_KEY', '')
    
    # YNAB API Configuration  
    YNAB_TOKEN: str = os.getenv('YNAB_TOKEN', '')
    YNAB_BUDGET: str = os.getenv('YNAB_BUDGET', 'last-used')
    YNAB_SW_ACCOUNT: str = os.getenv('YNAB_SW_ACCOUNT', 'Splitwise')
    YNAB_SW_CATEGORY: str = os.getenv('YNAB_SW_CATEGORY', 'Splitwise')
    
    # Sync Configuration
    USER_NAME: str = os.getenv('USER_NAME', 'you')
    SYNC_DAYS: int = int(os.getenv('SYNC_DAYS', '7'))
